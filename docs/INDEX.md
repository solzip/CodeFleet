...
작성 기준: 2026-08-13, 커밋 `cd353d1`. 전수 50개 문서 (감사 36 · 실행 8 · 아카이브 6).
...
| 08-13 | `archive/2026-08-13/README.original.md` | 결정 | 종료 전 루트 README. 동작하는 제품으로서 이 프로젝트를 어떻게 설명했는지의 기록. **내부 링크(`README.en.md`)는 해소되지 않는다** — 보존본이므로 고치지 않았다 | 상시 (아카이브) |
