...
작성 기준: 2026-08-13, 커밋 `cd353d1`. 전수 49개 문서 (감사 36 · 실행 7 · 아카이브 6).
...
| 08-13 | `archive/2026-08-13/README.original.md` | 결정 | 종료 전 루트 README. 동작하는 제품으로서 이 프로젝트를 어떻게 설명했는지의 기록 | 상시 (아카이브) |
