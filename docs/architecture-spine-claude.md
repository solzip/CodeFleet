...
설계를 모두 확정한 뒤에 구현을 순차적으로 재개한다.

```text
설계
1. risk policy rule expression 문법   ← 다음 병목
2. agentRoles taxonomy / profile rule id 네이밍
3. 정합성 최종 재감사
